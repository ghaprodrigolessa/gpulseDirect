...
function EvolucaoTerapiaOcupacional() {
  ...
  console.log('EVOLUÇÃO TERAPIA OCUPACIONAL!!!')
  ...
  useEffect(() => {
    if (tipodocumento == 'EVOLUÇÃO ESTRUTURADA - TO') {
  ...
  function Campos() {
    return (
      <div className="scroll"
        id="FORMULÁRIO - EVOLUÇÃO ESTRUTURADA - TO"
        style={{
          display: 'flex',
          flexDirection: 'column',
      ...
      >
        ...
        <div
          ...
          <div id="CORPO DO DOCUMENTO - EVOLUÇÃO ESTRUTURADA - CRP"
            ...
            {evolucaoSelecaoSimples(149, 'LOCAL DO ATENDIMENTO', 1)}
            ...
            {evolucaoSelecaoMultipla(153, 'INTERVENÇÕES RESTAURADORAS DAS FUNÇÕES DO CORPO', 1)}
            {evolucaoTexto(154, 'OUTRAS INTERVENÇÕES RESTAURADORAS DAS FUNÇÕES DO CORPO', 1, 'textarea', 2000, 600)}
            {evolucaoSelecaoMultipla(155, 'ATIVIDADE E PARTICIPAÇÃO', 1)}
            {evolucaoTexto(156, 'OUTRAS ATIVIDADES E PARTICIPAÇÕES', 1, 'textarea', 2000, 600)}
            {evolucaoSelecaoMultipla(157, 'FATORES AMBIENTAIS', 1)}
            {evolucaoTexto(158, 'OUTROS FATORES AMBIENTAIS', 1, 'textarea', 2000, 600)}
            {evolucaoTexto(159, 'OBSERVAÇÕES - TERAPIA OCUPACIONAL', 1, 'textarea', 2000, 600)}
            {evolucaoTexto(48, 'DISCUSSÃO INTERDISCIPLINAR', 1, 'textarea', 2000, 600)}
            {evolucaoTexto(160, 'TRANSIÇÃO DE CUIDADOS - TERAPIA OCUPACIONAL', 1, 'textarea', 2000, 600)}
  ...
  function Print() {
    return (
      <div id="IMPRESSÃO - EVOLUÇÃO ESTRUTURADA - TO" className="print">
  ...
  function printDiv() {
    ...
    axios.get('http://192.168.100.6:3333/pool_evolucoes_valores/' + idatendimento).then((response) => {
      ...
      setprintdocumento(1);
      setTimeout(() => {
        let printdocument = document.getElementById("IMPRESSÃO - EVOLUÇÃO ESTRUTURADA - TO").innerHTML;
  ...
  return (
    <div style={{
      display: tipodocumento == 'EVOLUÇÃO ESTRUTURADA - TO' && conselho == 'TO' && statusdocumento != null ? 'flex' : 'none',
      flexDirection: 'column', justifyContent: 'center',
    }}>
      <Campos></Campos>
      <div>
