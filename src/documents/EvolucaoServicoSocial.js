...
function EvolucaoServicoSocial() {
  ...
  console.log('EVOLUÇÃO SERVIÇO SOCIAL!!!')
  ...
  useEffect(() => {
    if (tipodocumento == 'EVOLUÇÃO ESTRUTURADA - CRESS') {
  ...
  function Campos() {
    return (
      <div className="scroll"
        id="FORMULÁRIO - EVOLUÇÃO ESTRUTURADA - CRESS"
        style={{
          display: 'flex',
          flexDirection: 'column',
      ...
      >
        ...
        <div
          ...
          <div id="CORPO DO DOCUMENTO - EVOLUÇÃO ESTRUTURADA - CRESS"
            ...
            {evolucaoSelecaoSimples(146, 'FREQUÊNCIA DE ATENDIMENTO', 1)}
            {evolucaoSelecaoMultipla(147, 'TIPO DE ATENDIMENTO', 1)}
            {evolucaoTexto(148, 'EVOLUÇÃO DA ASSISTÊNCIA SOCIAL', 1, 'textarea', 2000, 600)}
  ...
  function Print() {
    return (
      <div id="IMPRESSÃO - EVOLUÇÃO ESTRUTURADA - CRESS" className="print">
  ...
  function printDiv() {
    ...
    axios.get('http://192.168.100.6:3333/pool_evolucoes_valores/' + idatendimento).then((response) => {
      ...
      setprintdocumento(1);
      setTimeout(() => {
        let printdocument = document.getElementById("IMPRESSÃO - EVOLUÇÃO ESTRUTURADA - CRESS").innerHTML;
  ...
  return (
    <div style={{
      display: tipodocumento == 'EVOLUÇÃO ESTRUTURADA - CRESS' && conselho == 'CRESS' && statusdocumento != null ? 'flex' : 'none',
      flexDirection: 'column', justifyContent: 'center',
    }}>
      <Campos></Campos>
      <div>
